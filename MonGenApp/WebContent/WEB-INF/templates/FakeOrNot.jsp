...
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="w3-content">
    ...
    <div class="w3-center">
	    <form action="${pageContext.request.contextPath}/GenServlet" method="get">
	        <button type="reset" onclick="window.location.href = 'http://sal.livebytes.co.uk:8080/MonGenApp/gen';" class="w3-button w3-black w3-padding-large w3-large w3-margin-top">Try Again?</button>
        </form>
    </div>
  </div>
</div>
